...
When the document is __rendered__ the code also gets run, from top to bottom in the order it appears in the document, and the output inserted dynamically into the output document
...
We will continue using the register data example, and try out rmarkdown or quarto.

[Link to lesson](../lessons/dynamic-documents.html)
