...
4. Create a dynamic document that reads in the analysis file, and does some simple analyses. Present the results in a readable way using `knitr::kable` and using figures. Include prose describing what you are doing and why. 
